# Steps 
1. Make sure you are inside test folder
2. yarn install
3. yarn run test

# Hardhat Testing for Jungle Race [![Github Actions][gha-badge]][gha] [![Hardhat][hardhat-badge]][hardhat] [![License: MIT][license-badge]][license]
